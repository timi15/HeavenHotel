                            ...
                            <div className="col-md-4 col-xs-6">
                                <div className="footer">
                                    ...
                                    <ul className="footer-elerhetoseg">
                                        <li>
                                            <i className="fa fa-map-marker fa-lg" ></i>4400 Nyíregyháza Hotel utca 124.
                                        </li>
                                        <li>
                                            <a style={{ color: "black", textDecoration: "none" }} href="tel:+36301136090">
                                                <i className="fa fa-phone fa-lg"></i>+36 30 113 6090
                                            </a>
                                        </li>
                                        <li >
